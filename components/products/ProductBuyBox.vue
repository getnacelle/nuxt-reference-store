          ...
          >
            ...
            >
              ...
              >
                ...
                <span
                  :class="`${ activeImageIndex === index ? 'ring-indigo-500' : 'ring-transparent' } absolute inset-0 rounded-md ring-2 ring-offset-2 pointer-events-none`"
                  aria-hidden="true"
                ></span>
              </button>
            </div>
        ...
        <div class="mt-10 px-4 sm:px-0 sm:mt-16 lg:mt-0">
          ...
          <div class="mt-3">
            ...
            <p class="text-3xl text-gray-900">
              ...
              />
              <price
                v-if="product.selectedVariant.price < product.selectedVariant.compareAtPrice"
          ...
          <form class="mt-6">
            ...
            >
              ...
              <fieldset class="mt-2">
                ...
                <select
                  @change="handleSelectOption(option.name, $event)"
                ...
                >
                  <option
                    ...
                    :key="vIndex"
                    :value="value"
                    :selected="isOptionSelected(option.name, value)"
                    >{{ value }}</option
                  >
                </select>
              </fieldset>
            ...
            <div class="mt-10 flex">
              ...
              >
                <span v-if="product.selectedVariant.availableForSale"
                  >Add to bag</span
                >
